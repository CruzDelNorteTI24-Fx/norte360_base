...
if ($search != '') {
    $sql = "SELECT SQL_CALC_FOUND_ROWS
            ...
            JOIN tb_trabajador t ON e.clm_emerg_trabid = t.clm_tra_id
            WHERE t.clm_tra_nombres LIKE ? OR e.clm_emerg_nombre LIKE ? OR e.clm_emerg_celular LIKE ?
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= htmlspecialchars($row['clm_emerg_parentesco']) ?></td>
            <td><?= htmlspecialchars($row['clm_emerg_nombre']) ?></td>
            <td><?= htmlspecialchars($row['clm_emerg_celular']) ?></td>
        </tr>
        <?php endwhile; ?>
    </tbody>
</table>
