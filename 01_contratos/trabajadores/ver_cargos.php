...
if ($search != '') {
    $sql = "SELECT SQL_CALC_FOUND_ROWS clm_tra_id, clm_tra_nombres, clm_tra_dni, clm_tra_tipo_trabajador, clm_tra_cargo
            FROM tb_trabajador
            WHERE clm_tra_nombres LIKE ? OR clm_tra_dni LIKE ?
            ORDER BY clm_tra_tipo_trabajador
