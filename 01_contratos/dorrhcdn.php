...
<head>
    <meta charset="UTF-8">
    <title>Documentación | Norte 360°</title>
...
<nav id="nav-modulos" class="nav-bar-pro">
  ...
  ?>
    <!-- <li><a href="#" onclick="mostrarSubmenu('modulo-combustible')">⛽ Combustible</a></li>
    <li><a href="#" onclick="mostrarSubmenu('modulo-reportes')">📊 Reportes</a></li> -->
  </ul>
</nav>
...
<div class="menu-lateral" id="menuLateral">
  ...
  <ul>
    ...
    <li><a href="trabajadores/ver_cargos.php">Ver Cargos</a></li>    
